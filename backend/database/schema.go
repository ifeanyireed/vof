...
func seedInitialData(db *sql.DB) error {
	...
	if blogCount == 0 {
		...
		blogs := []struct {
			...
			},
			{
				...
				author:   "Glory Ozor",
				avatar:   "https://res.cloudinary.com/kmflnrxu/image/upload/v1790233561/vof/team/glory-ozor.png",
				date:     "March 9, 2026",
				day:      "09",
				month:    "MAR",
				likes:    3500,
			},
			{
				...
				avatar:   "https://res.cloudinary.com/kmflnrxu/image/upload/v1790233559/vof/team/achilleus-oguledo.jpg",
				date:     "April 7, 2026",
				day:      "07",
				month:    "APR",
				likes:    2900,
	...
	if galleryCount == 0 {
		...
		seedMedia := []struct {
			...
			{
				"Garment Construction Masterclass", "Vocational Skills", "https://res.cloudinary.com/kmflnrxu/image/upload/v1790233536/vof/IMG01.jpg", "image",
			...
			{
				"Sewing Starter Packs Presentation", "Vocational Skills", "https://res.cloudinary.com/kmflnrxu/image/upload/v1790233536/vof/IMG05.jpg", "image",
				"Graduation ceremony and presentation of sewing starter kits to certified alumni.", "2024-09-02",
				2024, "Nigeria", "VOIE Center, Owerri, Imo State", "VOIE Vocational Trades & Fashion Cohort", true,
			},
			{
				"Prenatal Wellness & Maternal Dignity Outreach", "Maternal Dignity", "https://res.cloudinary.com/kmflnrxu/image/upload/v1790233536/vof/IMG03.jpg", "image",
			...
			{
				"Secondary School Sponsorship Cohort", "Academic Scholarships", "https://res.cloudinary.com/kmflnrxu/image/upload/v1790233578/vof/root/IMG04.jpg", "image",
			...
			{
				"JAMB National Exam Coaching & Registration", "Academic Scholarships", "https://res.cloudinary.com/kmflnrxu/image/upload/v1790233559/vof/stats.jpg", "image",
